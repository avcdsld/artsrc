...
export const flowExplorerBaseUrl = process.env.REACT_APP_FLOWEXPLORER_BASE_URL || 'https://flow-view-source.com/testnet'
export const nftStorageApiKey = process.env.REACT_APP_NFT_STORAGE_KEY || '';
export const flowNetwork = process.env.REACT_APP_FLOW_NETWORK || 'testnet';
export const sourcesPerPage = 8;
